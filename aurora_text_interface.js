...
"text.htmlclean(string)<br/><span style='color:gray;font-size:small'>" + tr("[1.0.0] Clear text from html") + "</span>",
"text.htmltotext(string)<br/><span style='color:gray;font-size:small'>" + tr("[1.0.0] Clear text from html while preserving formatting") + "</span>",
