...
<%= _.template($('#input_constructor').html())({id:"Column", description:tr("File object functions"), default_selector: "string", disable_int:true

,variants: [
"file.pathcheck(path)<br/><span style='color:gray;font-size:small'>" + tr("[1.0.0] Page title") + "</span>",
"file.filecheck(path)<br/><span style='color:gray;font-size:small'>" + tr("[1.0.0] Page text") + "</span>",
"file.write(string, path)<br/><span style='color:gray;font-size:small'>" + tr("[1.0.0] Description text of the article/goods") + "</span>",
"file.listsave(string, path)<br/><span style='color:gray;font-size:small'>" + tr("[1.0.0] Additional description of the article/goods") + "</span>"
],
}) %>
