...
"asf.is_num()<br/><span style='color:gray;font-size:small'>" + tr("[1.0.0] Check for number") + "</span>",
"asf.var_isset()<br/><span style='color:gray;font-size:small'>" + tr("[1.0.0] Check for a variable existence") + "</span>",
"asf.global()<br/><span style='color:gray;font-size:small'>" + tr("[1.0.0] Global variable reading") + "</span>",
